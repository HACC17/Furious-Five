/* eslint-disable */
function masterScheduleMakerFunction () {
  var debug = false;
  ...
  function formatClassData (scheduleData) {
    ...
    debug && console.log(sortedSchedule);
...
export var ScheduleMaker = {makeSchedule: masterScheduleMakerFunction};
